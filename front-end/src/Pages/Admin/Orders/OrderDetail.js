    ...
    <div className="container mt-6">
      <div className="card shadow-lg">
        <div className="card-body">
          <h2 className="card-title display-4 text-center text-white">
            Order Details
          </h2>
          ...
          <div className="order-summary">
            ...
            <div className="order-item">
              <strong>Taxes:</strong>{' '}
              {order.total_tax === 0 ? 'No Tax' : order.total_tax}{' '}
              {order.currency}
            </div>
            <div className="order-item">
          ...
          <div className="shipping-info">
            ...
            <div className="shipping-item">
              ...
              {order.shipping_address?.address2 || 'N/A'}
            </div>
            <div className="shipping-item">
            ...
            <div className="shipping-item">
              ...
              {order.shipping_address?.province || 'N/A'}
            </div>
            <div className="shipping-item">
            ...
            <div className="shipping-item">
              ...
              {order.shipping_address?.company || 'N/A'}
            </div>
            <div className="shipping-item">
