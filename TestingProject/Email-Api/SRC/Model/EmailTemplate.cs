...
public class EmailTemplateTests
{
    ...
    {
        // Arrange
        var template = new EmailTemplate("Header: %%EMAIL_HEADER%%\nBody: %%EMAIL_BODY%%\nFooter: %%EMAIL_FOOTER%%");
    ...
    {
        // Arrange
        var template = new EmailTemplate("Body: %%EMAIL_BODY%%");
    ...
    {
    // Arrange
        var template = new EmailTemplate("Footer: %%EMAIL_FOOTER%%");
    ...
    {
    // Arrange
    var template = new EmailTemplate("Name: %%EMAIL_NAME%%");
    ...
    {
    // Arrange
    var template = new EmailTemplate("Sender: %%EMAIL_SENDER%%");
